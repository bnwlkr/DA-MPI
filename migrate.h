...
/*  processes regularly enter this function to see if a migration is necessary. If they decide that they should move to another proc, they will post that information at the bnode and wait for synchronization.
 *
 */
int airlock();
